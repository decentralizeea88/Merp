...
function seed() {
  ...
  const services = [
    { id: newId(), name: "Women's Haircut", category: 'Hair', price: 55, durationMin: 45, active: true },
    { id: newId(), name: "Men's Haircut", category: 'Hair', price: 35, durationMin: 30, active: true },
    { id: newId(), name: 'Full Color', category: 'Hair', price: 120, durationMin: 120, active: true },
    { id: newId(), name: 'Balayage', category: 'Hair', price: 180, durationMin: 150, active: true },
    { id: newId(), name: 'Blowout & Style', category: 'Hair', price: 45, durationMin: 40, active: true },
    { id: newId(), name: 'Classic Manicure', category: 'Nails', price: 30, durationMin: 30, active: true },
    { id: newId(), name: 'Gel Manicure', category: 'Nails', price: 45, durationMin: 45, active: true },
    { id: newId(), name: 'Spa Pedicure', category: 'Nails', price: 55, durationMin: 50, active: true },
    { id: newId(), name: 'Classic Facial', category: 'Skin', price: 75, durationMin: 60, active: true },
    { id: newId(), name: 'Deep Cleansing Facial', category: 'Skin', price: 95, durationMin: 75, active: true },
    { id: newId(), name: 'Eyebrow Shaping', category: 'Waxing', price: 20, durationMin: 15, active: true },
    { id: newId(), name: 'Full Leg Wax', category: 'Waxing', price: 65, durationMin: 45, active: true },
    { id: newId(), name: 'Swedish Massage (60 min)', category: 'Massage', price: 90, durationMin: 60, active: true },
    { id: newId(), name: 'Bridal Makeup', category: 'Makeup', price: 150, durationMin: 90, active: true }
  ];

  const staff = [
    { id: newId(), name: 'Sofia Marchetti', role: 'Senior Stylist', phone: '555-0101', email: 'sofia@bellavita.example', commissionPct: 40, active: true },
    { id: newId(), name: 'Amara Okafor', role: 'Colorist', phone: '555-0102', email: 'amara@bellavita.example', commissionPct: 40, active: true },
    { id: newId(), name: 'Linh Tran', role: 'Nail Technician', phone: '555-0103', email: 'linh@bellavita.example', commissionPct: 35, active: true },
    { id: newId(), name: 'Elena Petrova', role: 'Esthetician', phone: '555-0104', email: 'elena@bellavita.example', commissionPct: 35, active: true },
    { id: newId(), name: 'Maya Chen', role: 'Massage Therapist', phone: '555-0105', email: 'maya@bellavita.example', commissionPct: 45, active: true }
  ];
  ...
  const products = [
    { id: newId(), name: 'Argan Oil Shampoo 250ml', sku: 'SH-001', category: 'Hair Care', costPrice: 8, salePrice: 22, stock: 24, reorderLevel: 10 },
    { id: newId(), name: 'Keratin Repair Mask 200ml', sku: 'HM-002', category: 'Hair Care', costPrice: 11, salePrice: 28, stock: 14, reorderLevel: 8 },
    { id: newId(), name: 'Gel Polish — Ruby Red', sku: 'GP-101', category: 'Nails', costPrice: 4, salePrice: 12, stock: 6, reorderLevel: 8 },
    { id: newId(), name: 'Cuticle Oil 15ml', sku: 'CO-102', category: 'Nails', costPrice: 2.5, salePrice: 9, stock: 30, reorderLevel: 10 },
    { id: newId(), name: 'Hyaluronic Serum 30ml', sku: 'SR-201', category: 'Skin Care', costPrice: 14, salePrice: 42, stock: 9, reorderLevel: 6 },
    { id: newId(), name: 'SPF 50 Day Cream 50ml', sku: 'DC-202', category: 'Skin Care', costPrice: 9, salePrice: 26, stock: 4, reorderLevel: 6 },
    { id: newId(), name: 'Massage Oil — Lavender 1L', sku: 'MO-301', category: 'Massage', costPrice: 12, salePrice: 35, stock: 5, reorderLevel: 4 }
  ];
