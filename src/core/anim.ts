...
export const EASE = {
  ...
  settle:
    'linear(0, 0.2178 2.1%, 0.7929 7.6%, 1.0106 11.4%, 1.1245 14.9%, 1.1545 17%, 1.1596 19.1%, 1.1258 23.4%, 0.9973 34.1%, 0.9631 40.4%, 0.9563 44.7%, 0.9852 56.5%, 1.0026 68.3%, 1 100%)',
